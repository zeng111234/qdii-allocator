...
async function getFundNavHistory(fundCode, days) {
  if (!days) days = 750;
  var pageSize = 500; // 使用大页减少API请求数，避免限流
  ...
  var retryDelays = [1500, 3000]; // 增加重试间隔
...
async function getMarketSnapshot() {
  var indices = [
    { code: "100.NDX", name: "��˹���" },
    { code: "100.SPX", name: "����500" },
    { code: "100.DJIA", name: "����˹" },
    { code: "1.000001", name: "��ָ֤��" },
    { code: "100.HSI", name: "����ָ��" },
    { code: "100.VIXF", name: "VIX�ֻ�" },
    { code: "119.USDCNH", name: "��Ԫ/�����" }
  ];
